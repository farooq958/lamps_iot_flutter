          ...
          Container(
            ...
            child: SliderTheme(
              ...
              child: Slider(
                ...
                value: Repository.position.inSeconds.toDouble(),
                max: Repository.duration.inSeconds.toDouble(),
                onChanged: (value) {
                      ...
                      return InkWell(
                        ...
                        onTap: () {
                          if (playPauseState == true) {
                            ...
                            context.read<PlayPauseCubit>().playStatus(false);
                      ...
                      return InkWell(
                        ...
                        onTap: lastSongState
                            ...
                            : () {
                                ...
                                debugPrint(
                                    'search list length ${widget.searchedList.length}');
                                debugPrint(
                                    'normal list length ${widget.songItems!.data.toString().length}');
